    ...
    return (
        <div className="mb-10">
            ...
            <div className="flex gap-3 mb-6">
                <input type="text" placeholder="Enter Codeforces handle..." value={handle} onChange={e => setHandle(e.target.value)} onKeyDown={e => e.key === 'Enter' && fetchUserData()} className="px-4 py-2 rounded-lg bg-gray-800 text-white placeholder-gray-500 border border-gray-700 focus:outline-none focus:border-indigo-500 w-64" />
                <button
